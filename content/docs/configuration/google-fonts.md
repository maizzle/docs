...
<alert>Notice the <code>media="screen"</code> attribute on the last <code>&lt;link&gt;</code> tag - that helps avoid the Times New Roman fallback font bug in older versions of Outlook.</alert>
...
Now you can use the `font-open-sans` utility class in your HTML emails.
